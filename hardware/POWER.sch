...
LIBS:NEO-6M-0-001-tryout-cache
EELAYER 29 0
EELAYER END
...
AR Path="/5D123390/5C0AD747" Ref="U4"  Part="1" 
...
AR Path="/5D123390/5C0AD74D" Ref="C1"  Part="1" 
F 0 "C1" H 2159 2196 50  0000 R CNN
...
AR Path="/5D123390/5C0D4463" Ref="#PWR0111"  Part="1" 
F 0 "#PWR0111" H 2950 2300 50  0001 C CNN
...
AR Path="/5D123390/5C0D4465" Ref="C2"  Part="1" 
F 0 "C2" H 3592 2196 50  0000 L CNN
...
AR Path="/5D123390/5C0C1058" Ref="R5"  Part="1" 
F 0 "R5" H 2350 3950 50  0000 L CNN
...
AR Path="/5D123390/5C0C105F" Ref="#PWR0113"  Part="1" 
F 0 "#PWR0113" H 2250 4000 50  0001 C CNN
...
U 1 1 5C0D46AA
P 2250 3550
F 0 "D3" V 2300 3450 50  0000 R CNN
...
AR Path="/5D123390/5C14BD92" Ref="#PWR0115"  Part="1" 
F 0 "#PWR0115" H 3600 2300 50  0001 C CNN
...
AR Path="/5D123390/5C14C0B1" Ref="#PWR0116"  Part="1" 
F 0 "#PWR0116" H 2250 2300 50  0001 C CNN
...
U 1 1 5D00D601
P 4600 1500
F 0 "#PWR0118" H 4600 1350 50  0001 C CNN
...
U 1 1 5D00DAC3
P 4850 1500
F 0 "TP1" H 4950 1650 50  0000 L CNN
...
U 1 1 5D00E788
P 4600 1900
F 0 "#PWR0119" H 4600 1750 50  0001 C CNN
...
U 1 1 5D00EAB8
P 4850 1900
F 0 "TP2" H 4950 2050 50  0000 L CNN
...
AR Path="/5D123390/5D00F59D" Ref="#PWR0121"  Part="1" 
...
$EndComp
$Comp
L taobao-varistor:VAR_3V3,1206 R4
U 1 1 5D00FCA8
P 2950 3400
F 0 "R4" H 3100 3450 50  0000 L CNN
...
U 1 1 5D072C46
P 2250 1650
F 0 "JP1" V 2204 1718 50  0000 L CNN
...
U 1 1 5D077B21
P 3700 1650
F 0 "JP2" V 3654 1718 50  0000 L CNN
...
U 1 1 5D143145
P 3700 2150
F 0 "C3" H 3800 2200 50  0000 L CNN
F 1 "C106,0603" H 3800 2150 50  0000 L CNN
F 2 "Capacitor_SMD:C_0603_1608Metric_Pad1.05x0.95mm_HandSolder" H 3700 2150 50  0001 C CNN
